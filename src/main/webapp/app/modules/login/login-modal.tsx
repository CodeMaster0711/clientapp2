...
class LoginModal extends React.Component<ILoginModalProps, ILoginModalState> {
  ...
  render() {
    ...
    return (
      <Modal isOpen={this.props.showModal} toggle={handleClose} backdrop="static" id="login-page" size="lg">
          ...
          <div className="row">
            <div className="col-md-6">
              <AvForm onSubmit={this.handleSubmit}>
                ...
                <Button color="secondary" onClick={handleClose} tabIndex="1"><Translate
                  contentKey="entity.action.cancel"/></Button>{' '}
